(function initFloatingLauncher() {
  ...
  function applyText() {
    ...
    const labels = en ? { title: "Conversation Export", subtitle: "Save the current AI chat", custom: "Preview & select", customHint: "Choose messages, adjust content and export", directTitle: "Export the entire conversation", directHint: "Loads earlier messages without opening the full preview", directButton: "Download now", quick: "Other formats", visible: "Generated through preview", pdf: "Print / PDF", text: "Plain text", image: "Long image", copy: "Copy full chat as Markdown", settings: "Gesture settings", help: "Help", feedback: "Feedback" } : { title: "对话导出", subtitle: "从当前 AI 网页整理与保存", custom: "预览与筛选", customHint: "选择消息、调整内容并导出", directTitle: "一键导出全部对话", directHint: "自动加载较早消息，不打开全屏预览", directButton: "直接下载", quick: "其他格式", visible: "通过预览生成", pdf: "打印 / PDF", text: "纯文本", image: "长图", copy: "复制完整对话 Markdown", settings: "手势设置", help: "使用说明", feedback: "反馈" };
